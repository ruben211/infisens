...
exports.pantallas = (req, res) =>{
	res.sendFile("pantallas.html", {root: path.join(__dirname, "../../public/html")});
}

exports.dragandrop = (req, res) =>{
	res.sendFile("dragandrop.html", {root: path.join(__dirname, "../../public/html")});
}
